...
namespace mf_backend.DataAccess
{
    ...
    {
        private static readonly string SQL_CONNECTION = "Server=(local);uid=sa;pwd=123456;Database=MF_V29;Trusted_Connection=true;Encrypt=false";

        //private static readonly string SQL_CONNECTION = "Data Source=server-martarilfight.cpg2gtjagybb.ap-south-1.rds.amazonaws.com,1433;Initial Catalog=Final_DB_Server_MartarilFight; User ID=admin;Password=30092001;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
